...
export const createEventSpecialCategory = async (special_category: EventSpecialCategory) => {
    const { data } = await axios.post(`/events/specials/categories/`, special_category);
...
export const updateEventSpecialCategory = async (id: string, special_category: EventSpecialCategory) => {
    const { data } = await axios.put(`/events/specials/categories/${id}`, special_category);
