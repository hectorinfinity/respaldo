...
const Footer: React.FC<props> = ({ className }) => {
  ...
  const navigation = {
    help: [{ name: tm('help.contact'), href: '/landing/contact' }],
    information: [
  ...
  return (
    <footer className="bg-black" aria-labelledby="footer-heading">
      ...
      <div className="px-6 pt-16 pb-8 mx-auto max-w-7xl sm:pt-12 lg:px-8 lg:pt-16">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8">
            <Image
              ...
              width={200}
              height={120}
              className="self-center object-contain mt-2 select-none"
            />
            <p className="text-sm leading-6 text-gray-600">{tt('social')}</p>
        ...
        <div className="pt-8 mt-8 border-t border-white/10 sm:mt-20 lg:mt-16 lg:flex lg:items-center lg:justify-between">
          <div>
            <h3 className="text-sm font-semibold leading-6 text-white">
              {tt('newsletter.title')}
            </h3>
          ...
          <form
            ...
            method="POST"
            className="mt-6 w-80 sm:flex sm:max-w-md lg:mt-0"
          >
            <input
              id="email"
              type="email"
        ...
        <div className="pt-8 mt-8 border-t border-white/10 md:flex md:items-center md:justify-between">
          <p className="mt-8 text-xs leading-5 text-gray-400 md:order-1 md:mt-0">
            ...
            <Link
              href="/landing/term"
              className="text-white no-underline decoration-0"
            >
